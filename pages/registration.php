...
<?php
    ...
    ?>
        <div class="d-flex justify-content-center">
            <h2 class="mt-3 mb-5" style="color: #6F7071;" >Регистрация специалиста</р>
        </div>
        <div class="d-flex justify-content-center align-items-center">
        <div class="choose-border" style="width:700px;">
            <div class="form-container pt-2">
                <form class="row g-3 py-5 needs-validation d-flex justify-content-center align-items-center flex-column" action="/php/reg.php" method="POST" novalidate>
  ...
  <div class="col-12 d-flex justify-content-center align-items-center flex-column" style="width: 80%;"><a href="/pages/auth.php">Есть аккаунт?</a></div>
</form>
            </div>
        </div>
        </div>
